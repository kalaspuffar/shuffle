...
<div class="board-view-page" data-board-id="<?= (int) $board['id'] ?>" data-board-version="<?= (int) $board['version'] ?>" data-include-archived="<?= $includeArchived ? '1' : '0' ?>" data-labels="<?= htmlspecialchars($boardLabelsJson, ENT_QUOTES, 'UTF-8') ?>" data-label-palette="<?= htmlspecialchars($paletteJson, ENT_QUOTES, 'UTF-8') ?>" data-label-can-mutate="<?= $labelCanMutate ? '1' : '0' ?>">
...
$boardLang = json_encode([
    ...
    'board_sync'           => $lang->get('board.sync'),
