...
class User
{
    ...
    private const SELECT_COLUMNS = 'id, username, name, email, phone, location, bio, email_notifications, theme_preference, language, role, organization_id, is_placeholder, status, created_at, updated_at';
    ...
    {
        $allowedFields = ['name', 'email', 'phone', 'location', 'bio', 'email_notifications', 'theme_preference', 'language', 'role', 'organization_id', 'status', 'username', 'password_hash'];
        $setClauses = [];
        $params = [];
