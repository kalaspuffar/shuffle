...
<header class="app-header" role="banner">
    <div class="header-left">
        ...
        <nav class="header-nav" aria-label="<?= htmlspecialchars($lang->get('nav.main'), ENT_QUOTES, 'UTF-8') ?>">
            ...
            <a href="/priority.php" class="header-nav-link"<?= (isset($currentPage) && $currentPage === 'priority') ? ' aria-current="page"' : '' ?>><?= htmlspecialchars($lang->get('priority.nav'), ENT_QUOTES, 'UTF-8') ?></a>
    ...
    <div class="header-right">
        ...
        <div class="header-user-menu">
            ...
            <div class="user-dropdown" role="menu" hidden>
                <a href="/profile.php" role="menuitem" class="dropdown-btn dropdown-btn--link"><?= htmlspecialchars($lang->get('profile.nav'), ENT_QUOTES, 'UTF-8') ?></a>
